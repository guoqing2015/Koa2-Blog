...
* 分类列表
* */
router.get('/admin/category/list', Category.categoryListPage)

/*
 * 分类添加页面
 * */
router.get('/admin/category/add', async (ctx) => {
 ...
 * 分类的新增
 * */
router.post('/admin/category/add', Category.createCategory);
 ...
 * 分类修改
 * */
router.get('/admin/category/edit', Category.categoryEditPage)
/*
 * 分类修改保存
 * */
router.post('/admin/category/edit', Category.editCategory)
